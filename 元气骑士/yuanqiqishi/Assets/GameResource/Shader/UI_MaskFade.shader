...
_ClipSoftX ("Clip Soft X", Float) = 0
_ClipSoftY ("Clip Soft Y", Float) = 0
_SoftPower ("Soft Power", Float) = 1
...
void main()
{
    u_xlat0.xy = (-vs_TEXCOORD1.xy) + _ClipRect.zw;
    u_xlat0.xy = u_xlat0.xy / vec2(_ClipSoftX, _ClipSoftY);
    u_xlatb6.xy = greaterThanEqual(_ClipRect.zwzw, vs_TEXCOORD1.xyxy).xy;
    u_xlat6.xy = mix(vec2(0.0, 0.0), vec2(1.0, 1.0), vec2(u_xlatb6.xy));
    u_xlat0.xy = u_xlat6.xy * u_xlat0.xy;
    u_xlat0.xy = max(u_xlat0.xy, vec2(0.0, 0.0));
    u_xlat6.xy = vs_TEXCOORD1.xy + (-_ClipRect.xy);
    u_xlat6.xy = u_xlat6.xy / vec2(_ClipSoftX, _ClipSoftY);

...
void main()
{
    u_xlat10_0 = texture2D(_MainTex, vs_TEXCOORD0.xy);
    u_xlat16_0 = u_xlat10_0 * vs_COLOR0;
    u_xlat16_1 = dot(u_xlat16_0.xyz, _Filter.xyz);
    u_xlat16_0.x = u_xlat16_0.z * u_xlat16_1;
    SV_Target0.z = u_xlat16_0.w * u_xlat16_0.x;
    u_xlat16_0.x = u_xlat16_1 * 0.824999988;
    SV_Target0.x = u_xlat16_0.w * u_xlat16_1;
    SV_Target0.y = u_xlat16_0.w * u_xlat16_0.x;
    SV_Target0.w = u_xlat16_0.w;
    return;
}

...
void main()
{
    ...
    u_xlat16_0.x = dot(u_xlat16_1.xyz, vec3(0.5, 0.5, 0.5));
    u_xlat0.xyz = u_xlat16_0.xxx * _Filter.xyz;
    u_xlatb2 = u_xlat16_0.w!=0.0;
    SV_Target0.xyz = (bool(u_xlatb2)) ? u_xlat0.xyz : u_xlat16_1.xyz;
    u_xlat16_1.x = u_xlat16_0.w * 0.800000012;
    SV_Target0.w = (u_xlatb2) ? u_xlat16_1.x : u_xlat16_0.w;
    return;
}

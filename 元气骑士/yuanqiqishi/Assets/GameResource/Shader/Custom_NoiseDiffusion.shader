...
_LowCut ("Low Cut", Range(0, 1)) = 0
_HighCut ("High Cut", Range(0, 1)) = 1
}
SubShader {
...
uniform 	float _LowCut;
uniform 	float _HighCut;
...
void main()
{
    u_xlat10_0 = texture2D(_NoiseTex, vs_TEXCOORD1.xy).x;
    u_xlat0.x = u_xlat10_0 * _FadeAmount;
    u_xlat0.x = u_xlat0.x * _FadeSaturate;
    u_xlat0.x = clamp(u_xlat0.x, 0.0, 1.0);
    u_xlat0.x = u_xlat0.x + (-_LowCut);
    u_xlat2 = (-_LowCut) + _HighCut;
...
void main()
{
    u_xlat16_0 = texture(_NoiseTex, vs_TEXCOORD1.xy).x;
    u_xlat0.x = u_xlat16_0 * _FadeAmount;
    u_xlat0.x = u_xlat0.x * _FadeSaturate;
